package com.roy.testvideo.video;
...
import com.roy.testvideo.AppUtil;
import com.roy.testvideo.VideoUtil;
...
//            public void run() {
//                Log.e("TAG","Progress update started");
//                int progress = -1;
//                try {
//                    while (true) {
//                        sleep(50);
